...
Contributors: eddr
Tags: cart, woocommerce, sharing, saving, cart, wishlist
Tested up to: 6.8
Requires PHP: 7.4
...
- **Support forum** – Please use the [WordPress.org support forum](https://wordpress.org/support/plugin/cart-sharing-and-saving-for-woocommerce) for help and troubleshooting.
...
1. Upload the plugin files to the `/wp-content/plugins/cart-sharing-and-saving-for-woocommerce` directory, or install the plugin directly through the WordPress plugins screen.
